...
namespace Kernel::FS
{
	class EXT2BlockDeviceNode : public EXT2Node, public BlockDeviceNode
	{
		...
		EXT2BlockDeviceNode(DirectoryNode_v* parent, EXT2* fs, Utils::shared_ptr<detail::EXT2::inode_t> node, const Utils::string& name, const size_t inode_index, const devtarget_t&);
	};
